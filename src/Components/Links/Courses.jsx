...
const CoursesPage = () => {
  ...
  const coursesData = [
    ...
    { id: 1, title: 'C / C++ Programming', category: 'Programming & Development', description: 'Master the fundamentals of C and C++ from basic syntax to advanced topics like memory management and object-oriented programming.', level: 'Beginner', duration: '8 Weeks', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRAOQgBaemgW4KSYBJrMfpLVcIf81JKQNrKNQ&s' },
