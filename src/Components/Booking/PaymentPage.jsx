...
const Step3_BookSession = () => {
  ...
  const validCoupons = {
    ...
    'MENTOR50': { discount: 0.5, message: '50% discount has been applied.' },
    'SAVE20': { discount: 0.2, message: '20% discount has been applied.' }
  };
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('Payment processing is not implemented. Your session is booked!');
  };
      ...
      <div className="payment-page-body">
        <div className="booking-page-container">
          ...
          <div className="progress-steps-container">
              <div className="progress-step completed"><div className="step-circle">1</div><div className="step-label">Find Mentor</div></div>
              <div className="progress-connector" style={{background: 'linear-gradient(90deg, #4f46e5, #6d28d9)'}}></div>
              <div className="progress-step completed"><div className="step-circle">2</div><div className="step-label">View Profile</div></div>
              <div className="progress-connector" style={{background: 'linear-gradient(90deg, #4f46e5, #6d28d9)'}}></div>
              <div className="progress-step active"><div className="step-circle">3</div><div className="step-label">Book Session</div></div>
          </div>

          <div className="confirmation-layout-grid">
              <div className="summary-column">
                  <div className="summary-header">
                      <img src={bookingDetails.avatar} alt={bookingDetails.mentorName} className="summary-avatar" />
...
export default Step3_BookSession;
